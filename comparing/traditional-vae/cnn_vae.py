...
generated_path = '../../data/generated_data/cnn_vae_generation_slaac_privacy_addresses.txt'
...
def run_model():
    ...
    h = Conv1D(32, 3, padding='same', activation='relu', strides=1)(input_vec)
    ...
    decoder_cnn = Conv1D(32, 3, padding='same', activation='relu', strides=1)
    ...
    vae.save_weights('../../models/cnn_vae.model')
