...
generation_path = '../../data/generated_data/gru_vae_generation_1014.txt'
...
def run_model():
    ...
    h = GRU(16, return_sequences=True)(input_vec)
    h = GRU(16)(h)
    ...
    decoder_rnn = GRU(16, return_sequences=True)
    ...
    vae.save_weights('../../models/gru_vae_1014.model')
